                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-surface">
                      <tr>
                        ...
                        <th className="eyebrow text-right font-normal px-4 py-2.5">ST medio</th>
